 ...
 -->  
  ...
  <link href="<c:url value="/css/jquery.bdt.css"/>"  rel="stylesheet" type="text/css" />
    ...
    <link href="<c:url value="/css/daterangepicker.css"/>"  rel="stylesheet" type="text/css" />
       ...
       <link href="<c:url value="/css/calendar_main.css"/>"  rel="stylesheet" type="text/css" />
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#" onclick="redirection('index');">
        <div class="sidebar-brand-icon rotate-n-15">
          <i class="fas fa-laugh-wink"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Hawk admin <sup>0.1</sup></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#" onclick="redirection('index');">
      ...
      <hr class="sidebar-divider">
 <li class="nav-item">
        <a class="nav-link" onclick="redirection('enquiry_follow');"href="#">
          <i class="fas fa-fw fa-table"></i>
          <span>Enquiry  Follow</span></a>

      </li>
       <li class="nav-item">
          <a class="nav-link" onclick="redirection('new_client');"href="#">
          <i class="fas fa-fw fa-table"></i>
       ...
       <li class="nav-item">
           <a class="nav-link" onclick="redirection('client_quick_view');"href="#">
          <i class="fas fa-fw fa-table"></i>
          <span>Client Quick View</span></a>
      </li>
       <!-- <li class="nav-item">
         <a class="nav-link" onclick="redirection('assessment_module');"href="#">
          <i class="fas fa-fw fa-table"></i>
          <span>Insanity Assessment</span></a>

      </li> -->
       <li class="nav-item">
         <a class="nav-link" onclick="redirection('friday_challenge');"href="#">
          <i class="fas fa-fw fa-table"></i>
          <span>Friday Challenge</span></a>
      </li>
      
      
      
       <li class="nav-item">
         <a class="nav-link" onclick="redirection('workout_module');"href="#">
          <i class="fas fa-fw fa-table"></i>
          <span>Workout Module</span></a>
      </li>
      
      
       <li class="nav-item">
         <a class="nav-link" onclick="redirection('insanity_workout_module');"href="#">
          <i class="fas fa-fw fa-table"></i>
          <span>Insanity WorkOut Module</span></a>
      </li>
      
       <li class="nav-item">
         <a class="nav-link" onclick="redirection('account_management');"href="#">
          <i class="fas fa-fw fa-table"></i>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" id="client_Id" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <button class="btn btn-primary" onclick="serarch();" type="button">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="https://pbs.twimg.com/profile_images/1093402030645760001/h-ewD1Ld_400x400.jpg" style="background-color: black;">
              </a>
    ...
    <script type="text/javascript" src="<c:url value="/js/adminlte.min.js"/>"></script> 
       <script type="text/javascript" src="<c:url value="/vendor/chart.js/Chart.min.js"/>"></script> 
        ...
        <script type="text/javascript" src="<c:url value="/js/jquery.dataTables.min.js"/>"></script>
           <script type="text/javascript" src="<c:url value="/js/calendar_main.js"/>"></script>
            <script type="text/javascript" src="<c:url value="/js/day_calendar_main.js"/>"></script>
         <script type="text/javascript" src="<c:url value="/js/commonAPI.js"/>"></script> 
         <script type="text/javascript" src="<c:url value="/js/commonAPI2.js"/>"></script> 
...
<!--     <script type="text/javascript" src="https://cdn.fusioncharts.com/fusioncharts/latest/fusioncharts.js"></script>
   ...
   -->       
         <!--   calender update -->
        <script>
client_quick_view_list_request();
</script>
