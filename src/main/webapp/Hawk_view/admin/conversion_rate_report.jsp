...
<meta charset="ISO-8859-1">
 <title>Conversion Rate Report</title>
 <%@include file="../admin/header.jsp" %>
  </head>  
<body class="hold-transition sidebar-mini">
<!-- Site wrapper -->
<div class="wrapper" id="conversion_rate_report">

 <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Conversion Rate Report</h1>
...
<div class="modal fade" id="enquiry_editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
            ...
            <div class="row">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <input type="text"  name="discount" id="discount" class="form-control" value="0" onchange="paid_amount();" disabled="disabled">
              </div>	
           </div>  
            <div class="col-md-6">
                 <div class="form-group">
                ...
                <label for="due_Amount">Due Pay</label>
                   <input type="text"  name="duePay" id="duePay" class="form-control" value="0"  onchange="paid_amount();">
      ...
      <div class="modal-footer">
       <button type="button" class="btn btn-secondary btn-success" onclick="update_pending_due();">Update</button>
  ...
  <script>
  conversion_rate_report_onload();
  $("#conversion_rate_report").appendTo($("#parent_continer"));
  </script>
  </body>
  </html>